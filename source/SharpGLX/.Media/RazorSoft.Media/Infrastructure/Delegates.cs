...
namespace RazorSoft.Media {
    ...
    internal delegate void CharCallback(NativeWindow window, uint codePoint);
    /// <summary>
    ///     This is the function signature for Unicode character callback functions.
    /// </summary>
    /// <param name="window">The window handle.</param>
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void CharModsCallback(NativeWindow window, uint codePoint, ModifierKeys mods);
    /// <summary>
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void FileDropCallback(NativeWindow window, int count, IntPtr arrayPtr);
    /// <summary>
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void FocusCallback(NativeWindow window, bool focusing);
    /// <summary>
    ...
    /// <param name="mods">	Bit field describing which modifier keys were held down.</param>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void KeyCallback(NativeWindow window, Keys key, int scanCode, InputState state, ModifierKeys mods);
    /// <summary>
    ...
    /// <param name="status">The connection status.</param>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void MonitorCallback(NativeScreen monitor, ConnectionStatus status);
    /// <summary>
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void MouseCallback(NativeWindow window, double x, double y);
    /// <summary>
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void MouseEnterCallback(NativeWindow window, bool entering);
    /// <summary>
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void MouseButtonCallback(NativeWindow window, MouseButton button, InputState state, ModifierKeys modifiers);
    /// <summary>
    ///     This is the function signature for cursor position callback functions.
    /// </summary>
    /// <param name="window">The window handle.</param>
    ...
    /// <param name="y">The new cursor y-coordinate, relative to the left edge of the client area.</param>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void PositionCallback(NativeWindow window, double x, double y);
    /// <summary>
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void SizeCallback(NativeWindow window, int width, int height);
    /// <summary>
    ///     Generic signature for window callbacks.
    /// </summary>
    /// <param name="window">The window handle.</param>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void WindowCallback(NativeWindow window);
    /// <summary>
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void WindowContentsScaleCallback(NativeWindow window, float xScale, float yScale);
    /// <summary>
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void WindowMaximizedCallback(NativeWindow window, bool maximized);
}
