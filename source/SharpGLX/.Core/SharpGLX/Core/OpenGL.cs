...
namespace SharpGLX {
    ...
    public partial class OpenGL {
        ...
        /// </summary>
        /// <param name="nobj">The NURBS object.</param>
        public void BeginSurface(IntPtr nobj) {
            PreGLCall();
        ...
        /// <summary>
        /// This function deletes the underlying glu nobj renderer.
        /// </summary>
        /// <param name="nobj">The pointer to the nobj object.</param>
        public void DeleteNurbsRenderer(IntPtr nobj) {
            PreGLCall();
        ...
        public void DeleteQuadric(IntPtr qobj) {
            PreGLCall();
        ...
        /// </summary>
        /// <param name="nobj">The nobj object.</param>
        ...
        /// </summary>
        /// <param name="nobj">The nobj object.</param>
        public void EndSurface(IntPtr nobj) {
            PreGLCall();
            gluEndSurface(nobj);
            PostGLCall();
        }
        ...
        public IntPtr NewNurbsRenderer() {
            PreGLCall();
            IntPtr nobj = gluNewNurbsRenderer();
            PostGLCall();
        ...
        public void NurbsCurve(IntPtr nobj, int knotsCount, float[] knots,
            int stride, float[] controlPointsArray, int order, uint type) {
            PreGLCall();
            gluNurbsCurve(nobj, knotsCount, knots, stride, controlPointsArray,
                order, type);
            PostGLCall();
        }
        ...
        /// </summary>
        /// <param name="nobj">The object to set the property for.</param>
        /// <param name="property">The property to set.</param>
        /// <param name="value">The new value of the property.</param>
        public void NurbsProperty(IntPtr nobj, int property, float value) {
            PreGLCall();
        ...
        /// <param name="type">The type of data to generate.</param>
        public void NurbsSurface(IntPtr nobj, int sknotsCount, float[] sknots, int tknotsCount, float[] tknots,
            int sStride, int tStride, float[] controlPointsArray, int sOrder, int tOrder, uint type) {
            PreGLCall();
            gluNurbsSurface(nobj, sknotsCount, sknots, tknotsCount, tknots,
        ...
        /// <param name="renderContext">Type of the render context.</param>
        /// <param name="width">The drawing context width.</param>
        /// <param name="height">The drawing context height.</param>
        /// <param name="bitDepth">The bit depth.</param>
        /// <param name="parameter">The parameter.</param>
        /// <returns></returns>
        public virtual bool Create(OpenGLVersion openGLVersion, RendererContexts renderContext, int width, int height, int bitDepth, object parameter) {
            ...
            renderer.Create(openGLVersion, this, width, height, bitDepth, parameter);
        ...
        public virtual bool CreateFromExternalContext(OpenGLVersion openGLVersion, int width, int height, int bitDepth, IntPtr windowHandle, IntPtr renderContextHandle, IntPtr deviceContextHandle) {
            ...
            renderer = new Renderer(windowHandle, renderContextHandle, deviceContextHandle);
            renderer.Create(openGLVersion, this, width, height, bitDepth, null);
		...
		public virtual void MakeCurrent() {
            //  As long as we have a renderer, make it current.
            if (renderer != null) {
        ...
        public virtual void Blit(IntPtr deviceContextHandle) {
            ...
            if (renderer != null)
                renderer.Blit(deviceContextHandle);
        }
        ...
        /// </summary>
        internal static FontBitmaps FontBitmaps { get; set; }

        /// <summary>
        /// The FontOutlines object is used to allow rendering of text.
        /// </summary>
        internal static FontOutlines FontOutlines { get; set; }
        ...
        public IRenderer RenderContextProvider {
            get { return renderer; }
        }
