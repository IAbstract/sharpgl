...
namespace SharpGLX {
    ...
    public partial class OpenGL {
        public delegate IntPtr GetProcAddr(string functionName);

        public static GetProcAddr GetProcAddress { get; set; }
        ...
        public bool IsExtensionFunctionSupported(string extensionFunctionName) {
            ...
            IntPtr procAddress = GetProcAddress(extensionFunctionName);
