...
using SharpGLX.Windows.Renderers;
using SharpGLX.Windows.Forms.Design;


namespace SharpGLX.Windows.Forms {

    /// <summary>
    /// This is the basic OpenGL control object, it gives all of the basic OpenGL functionality.
    /// </summary>
    [ToolboxBitmap(typeof(OpenGLControl), "SharpGLX.png")]
    ...
    public partial class OpenGLControl : UserControl, ISupportInitialize {
        ...
        protected override void OnPaintBackground(PaintEventArgs e) {
            if (RenderContextType == WindowsRendererContexts.NativeWindow) {
                return;
            }
        ...
        /// </value>
        [Description("The render context type."), Category("SharpGLX")]
        public RendererContexts RenderContextType { get; set; } = WindowsRendererContexts.DIBSection;
