...
namespace SharpGLX.Windows.Renderers {
    ...
    public class FBORenderer : HiddenWindowRenderer {
        /// <summary>
        /// Initializes a new instance of the <see cref="FBORenderer"/> class.
        /// </summary>
        public FBORenderer() {
        ...
        private void CreateDBOs(OpenGLVersion openGLVersion, OpenGL gl, int width, int height, int bitDepth, object parameter) {
            ...
            dibSectionDeviceContext = Win32.CreateCompatibleDC(deviceHandle);
