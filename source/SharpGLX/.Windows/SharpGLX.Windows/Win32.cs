...
using SharpGLX.Windows.Fonts;


namespace SharpGLX.Windows {
	...
	public static class Win32 {
        ...
        /// </summary>
        static Win32() {
            OpenGL.FontBitmaps = new WinFontBitmaps();
            OpenGL.FontOutlines = new WinFontOutlines();
            OpenGL.GetProcAddress = wglGetProcAddress;
